namespace AutonomerSForm
{
    public static class Constants
    {
        ...
        public const string PathToPythonScript = @"Core\AutonomersPythonProject\v7-detect_machine.py";
        public const string PathToGenerateDbScript = @"Core\CreateDbScript.sql";
